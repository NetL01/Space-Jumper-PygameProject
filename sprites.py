...
class Monster(Sprite):
    def __init__(self, x_location, y_location, x_doodle, y_doodle, time_to):
        Sprite.__init__(self, x_location, y_location)
        self.init_image('img/monster.png')
        self.Vx = (x_doodle - x_location) / time_to
        self.Vy = (y_doodle - y_location) / time_to
